...
\begin{enumerate}
    ...
    \item The output is to be expected when the problem is solved.
    
    \item The solution to this problem is within the given constraints.
\end{enumerate}
...
\section{Types of Sorting Algorithms}

\section{Complexity Analysis of Sorting Algorithms}
