...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}
        ...
        \draw[fill=yellow!30] (0, 0) rectangle (1, 1);
        \node at (0.5, 0.5) {0};

        \node at (0.5, 1.25) {Pivot};
        ...
        % 3rd Iteration - FINAL
        \draw[fill=green!30] (0, -2) rectangle (1, -1);
        \node at (0.5, -1.5) {0};

        \node at (0.5, -0.75) {Pivot};
        ...
        \node at (5.5, -4.75) {Pivot};

        % 5th Iteration
        \node at (-3, -6.25) {5th Partition};
        \draw[dashed] (-4, -6.5) -- (11, -6.5);

        \draw[fill=yellow!30] (6, -8) rectangle (7, -7);
        \node at (6.5, -7.5) {9};

        \node at (6.5, -6.75) {Pivot};

        % 5th Iteration - FINAL
        \draw[fill=green!30] (6, -10) rectangle (7, -9);
        \node at (6.5, -9.5) {9};

        \node at (6.5, -8.75) {Pivot};

        % Sorted Array
        \node at (-3, -10.25) {Sorted Array};
        \draw[dashed] (-4, -10.5) -- (11, -10.5);

        \draw[fill=green!30] (0, -12) rectangle (1, -11);
        \node at (0.5, -11.5) {0};
        \draw[fill=green!30] (1, -12) rectangle (2, -11);
        \node at (1.5, -11.5) {1};
        \draw[fill=green!30] (2, -12) rectangle (3, -11);
        \node at (2.5, -11.5) {2};
        \draw[fill=green!30] (3, -12) rectangle (4, -11);
        \node at (3.5, -11.5) {6};
        \draw[fill=green!30] (4, -12) rectangle (5, -11);
        \node at (4.5, -11.5) {7};
        \draw[fill=green!30] (5, -12) rectangle (6, -11);
        \node at (5.5, -11.5) {8};
        \draw[fill=green!30] (6, -12) rectangle (7, -11);
        \node at (6.5, -11.5) {9};
    \end{tikzpicture}
    \caption{Quick Sort}
    \label{fig:quick-sort}
